...
class Dashboard(ctk.CTk):
    ...
    def setup_bottom_sidebar(self):
        ...
        # Theme Switch
        self.theme_switch = ctk.CTkSwitch(bottom_frame, text="☾ / ☀︎", font=("Arial", 12), command=self.change_appearance_mode)
    ...
    def load_role_content(self, user):
        ...
        if role == 'admin': 
            ...
            self.tracker = MemberTracking(user_id=user['id'], server_url="http://192.168.100.109:5000")
