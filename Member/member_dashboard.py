...
class MemberDashboard(ctk.CTkFrame):
    def __init__(self, master, user, db):
        ...
        ctk.CTkLabel(self.welcome_f, 
                     text="Your performance overview for today.", 
                     font=("Arial", 14), text_color="gray").pack(anchor="w", pady=5)
    ...
    def refresh_stats(self):
        ...
        stats = [
            ...
            {"title": "Attendance", "value": "9/11", "color": "#9B59B6"}
        ]
    ...
    def create_card(self, master, title, value, color):
        ...
        line = ctk.CTkFrame(card, height=4, fg_color=color)
